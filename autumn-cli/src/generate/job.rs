...
fn render_job_file(
    ...
    let smoke_test = render_smoke_test(snake_name, args_struct, companion_struct);
    format!(
...
fn render_smoke_test(snake_name: &str, _args_struct: &str, companion_struct: &str) -> String {
    format!(
        r#"
#[cfg(test)]
