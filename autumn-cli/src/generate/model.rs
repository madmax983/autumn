...
use super::schema_edit::{
    add_mod_declaration, append_schema_table, create_table_sql, create_table_sql_with_metadata,
    drop_table_sql,
};
...
pub fn plan_model_with_options(
    ...
    let up_sql = if metadata.indexes().is_empty() && metadata.defaults().is_empty() {
