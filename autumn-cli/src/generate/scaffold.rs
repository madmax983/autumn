...
fn render_repository_file(pascal_name: &str, snake_name: &str) -> String {
    ...
    format!(
        "//! Generated by `autumn generate scaffold`.\n\
         //!\n\
         //! `#[repository]` auto-generates CRUD methods and JSON REST routes.\n\
         //! Production builds should pair mutating API routes with a policy,\n\
         //! or explicitly opt in via `security.allow_unauthorized_repository_api`.\n\
         \n\
