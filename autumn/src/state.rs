...
impl crate::actuator::ProvideActuatorState for AppState {
    ...
    fn a11y_posture(&self) -> crate::actuator::A11yPosture {
        // The scaffold generated by `autumn new` ships with lang="en", a skip link,
        // and semantic landmark regions out of the box, so report compliance rather
        // than the all-false default from the trait.
        crate::actuator::A11yPosture {
            lang_set: true,
